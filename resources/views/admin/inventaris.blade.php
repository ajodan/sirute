    ...
    <div class="relative">
        ...
        <div class="flex justify-between pb-5">
            ...
            <button data-modal-target="tambah-inventaris" data-modal-toggle="tambah-inventaris"
                class="block text-white bg-blue-700 hover:bg-blue-800 dark:bg-purple-700 dark:hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-purple-800"
                type="button">
                Tambah Barang
            </button>
        </div>
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4 flex gap-2">
                                <button onclick="showEdit({{ $item }})" data-modal-target="edit-inventaris"
                                    data-modal-toggle="edit-inventaris"
