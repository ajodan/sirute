<x-layout.admin-layout>
    <div class="relative">
        ...
        <div class="flex justify-between pb-5">
            <h1> </h1>
            <!-- Modal toggle -->
            <button data-modal-target="tambah-surat" data-modal-toggle="tambah-surat" class="block text-white bg-blue-700 hover:bg-blue-800 dark:bg-purple-700 dark:hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-blue-800" type="button">
                Tambah Surat
            </button>
        </div>
        @if (session('success'))
