                        ...
                        <div class="sm:grid grid-cols-3">
                            ...
                            <div class="col-span-2 order-2 sm:order-1">
                                <p class="text-base font-normal text-gray-500 lg:text-base pt-3 dark:text-gray-400">Ini
                                    adalah data profil lengkap warga RW13, yang mencakup informasi pribadi, alamat, status
                                    kependudukan, dan data penting lainnya yang relevan untuk keperluan administratif
                                    dan sosial.</p>
                                <div class="flex flex-row justify-between gap-5 pt-5">
                                    <div class="flex">
                                        <dl
                                            ...
                                            <div class="flex flex-col py-3">
                                                <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Alamat Lengkap</dt>
                                    ...
                                    placeholder="">
                                            ...
                                            <div class="flex flex-col pt-3">
                                                ...
                                                <dd class="text-lg font-semibold">{{ $penduduk->pendidikan }}</dd>
                                            </div>
                ...
                <div class="gap-y-2 flex flex-col text-center">
                    ...
                    <div class="mx-auto max-w-6xl font-sans pb-12">
                        @if ($berita == null || $berita->isEmpty())
                            <div class="flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-[#2d1c63] dark:text-red-400"
                                role="alert">
                                <div>
                        ...
                        @foreach ($berita as $item)
                            <div id="alert-additional-content-3 "
                                class="p-4 mb-4 w-[70vw] gap-y-2 mx-auto text-purple-800 border border-purple-300 rounded-lg bg-purple-50 dark:bg-[#2d1c63] dark:text-purple-200 dark:border-purple-800"
                                role="alert">
                    ...
                    <section class="max-w-6xl mx-auto font-sans">
                        <div class="display mt-8">
                            @if ($umkm == null || $umkm->isEmpty())
                                <div class="flex items-center p-4 mb-4 text-sm text-blue-800 rounded-lg bg-purple-50 dark:bg-[#2d1c63] dark:text-blue-400"
                                    role="alert">
                                    ...
                                    <div>
                                        {{ $penduduk->nama }} belum memiliki umkm.
                                    </div>
                                </div>
                            @endif
                        </div>
                            ...
                            @foreach ($umkm as $item)
                                <a href="{{ route('user.umkm.detail', $item->id_umkm) }}">
                                    <div class="group relative">
                                        <div
                                            class="{{ $item->tokoBuka() ? 'hidden' : '' }} absolute bg-slate-950 dark:bg-[#2d1c63] rounded-2xl w-full h-full opacity-30">
                                        </div>
